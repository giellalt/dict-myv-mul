# Dictionary for myv — mul

This repository contains source files for a dictionary from Erzya to Multiple languages. The content is licensed under the CC-BY-4.0 license.
